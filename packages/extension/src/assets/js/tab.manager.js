...
(function () {
  ...
  var createWindowWithTabs = (function () {
    var _ref = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee(tabs, isIncognito) {
        var pinnedIndex,
          firstTab,
          t,
          i,
  ...
  var focusOnTabAndWindow = (function () {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee2(tab) {
        var windowId, tabId;
        return regeneratorRuntime.wrap(
    ...
    return function focusOnTabAndWindow(_x3) {
  ...
  var tabAdded = (function () {
    var _ref4 = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(tab) {
              ...
              switch ((_context7.prev = _context7.next)) {
                ...
                case 3:
                  ...
                  if (!!window.tabsActive && window.tabsActive.length > 1) {
                    currentTab =
                      window.tabsActive[window.tabsActive.length - 1];
                    previousTab =
                ...
                case 6:
                  ...
                  return _context7.abrupt(
                    "return",
                    focusOnTabAndWindow(previousTab)
                  );
                case 13:
                  return _context7.abrupt(
                    "return",
            ...
            while (1) {
              switch ((_context8.prev = _context8.next)) {
                case 0:
                  ...
                  _context8.next = 6;
                  return browser.browserAction.onClicked.removeListener(
                    openAsOwnTab
                  );
                case 6:
                  if (!openInOwnTab) {
                ...
                case 9:
                  _context8.next = 11;
                  return browser.browserAction.onClicked.addListener(
                    openAsOwnTab
                  );
                case 11:
                  _context8.next = 15;
                ...
                case 2:
                  ...
                  browser.contextMenus.create({
                    ...
                    onclick: function onclick(info, tab) {
                      browser.tabs.create({
                        url:
                          "https://github.com/stefanXO/Tab-Manager-Plus/issues",
                      });
                    },
                  });
  ...
  var hideWindows = (function () {
    var _ref10 = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee11(windowId) {
        var result;
        return regeneratorRuntime.wrap(
                      ...
                      (function () {
                        var _ref11 = _asyncToGenerator(
                          /*#__PURE__*/ regeneratorRuntime.mark(
                            function _callee10(windowId, displaylayouts) {
                                    ...
                                    switch (
                                      ...
                                      case 0:
                                        ...
                                        for (
                                          ...
                                          window.displayInfo.push(
                                            displaylayout.bounds
                                          );
                                        }
                                        _context10.next = 12;
                                        break;
    ...
    return function hideWindows(_x5) {
            ...
            while (1) {
              switch ((_context13.prev = _context13.next)) {
                ...
                case 2:
                  ...
                  _context13.prev = 7;
                  for (
                    _iterator3 = activewindows[Symbol.iterator]();
                ...
                case 23:
                  ...
                  _context13.prev = 33;
                  for (
                    _iterator4 = Object.keys(names)[Symbol.iterator]();
                ...
                case 37:
                  _context13.prev = 37;
                  _context13.t1 = _context13["catch"](33);
  ...
  function windowFocus(windowId) {
    try {
      if (!!windowId) {
        windowActive(windowId); // console.log("onFocused", windowId);
  ...
  function windowRemoved(windowId) {
    ...
    } catch (e) {} // console.log("onRemoved", windowId);
  }
  ...
  function windowActive(windowId) {
    ...
    localStorage["windowAge"] = JSON.stringify(windows); // browser.windows.getLastFocused({ populate: true }, function (w) {
