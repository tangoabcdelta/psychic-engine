...
// import {flex, flexWrap} from "tailwindcss";

const SoftlineSelection = (props: any) => {
  return (
      ...
      <form className="flex-auto p-6">
        ...
        <div className="flex items-baseline mt-4 mb-6">
          <div className="space-x-2 flex">
            <label>
              <input className="w-9 h-9 flex items-center justify-center bg-gray-100 rounded-lg" name="size" type="radio" defaultValue="xs" defaultChecked />
              XS
            </label>
            <label>
              <input className="w-9 h-9 flex items-center justify-center" name="size" type="radio" defaultValue="s" />
              S
            </label>
            <label>
              <input className="w-9 h-9 flex items-center justify-center" name="size" type="radio" defaultValue="m" />
              M
            </label>
            <label>
              <input className="w-9 h-9 flex items-center justify-center" name="size" type="radio" defaultValue="l" />
              L
            </label>
            <label>
...
export default SoftlineSelection;
